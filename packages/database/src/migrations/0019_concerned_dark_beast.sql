...
CREATE TABLE `__new_quiz_question` (
	...
	FOREIGN KEY (`source_material_id`) REFERENCES `material`(`id`) ON UPDATE no action ON DELETE set null
);
--> statement-breakpoint
INSERT INTO `__new_quiz_question`("id", "deck_id", "quiz_id", "type", "question", "explanation", "correct_answer", "source_material_id", "created_at") SELECT "id", "deck_id", "quiz_id", "type", "question", "explanation", "correct_answer", "source_material_id", "created_at" FROM `quiz_question`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_session_activity`("id", "session_id", "type", "deck_id", "quiz_id", "material_id", "started_at", "completed_at") SELECT "id", "session_id", "type", "deck_id", "quiz_id", "material_id", "started_at", "completed_at" FROM `session_activity`;--> statement-breakpoint
